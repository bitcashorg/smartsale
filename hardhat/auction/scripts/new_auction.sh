...
bun run hardhat initiateAuction --auctioning-token $AUCTIONING_TOKEN --bidding-token $BIDDING_TOKEN --sell-amount 0.1 --min-buy-amount 50 --auction-end-date 1708809585 --network $NETWORK 
