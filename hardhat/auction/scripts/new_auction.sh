...
bun run hardhat initiateAuction --auctioning-token $AUCTIONING_TOKEN --bidding-token $BIDDING_TOKEN --sell-amount 250000 --min-buy-amount 125000 --auction-end-date 1711349042 --network $NETWORK 
