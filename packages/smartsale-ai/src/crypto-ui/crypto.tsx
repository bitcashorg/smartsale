...
export function Crypto({ symbol, price, delta }: Crypto) {
  ...
  }, [startHighlight, endHighlight, setAIState])
      ...
      >
        ...
        {startHighlight ? (
          <div
            ...
            style={{
              left: `${startHighlight}%`,
              width: `${endHighlight - startHighlight}%`,
            }}
          />
        ) : null}
        ...
        >
          <defs>
            <linearGradient
              ...
              y2="100%"
            >
              <stop offset="0%" stopColor="#34a853" stopOpacity="0.38" />
              <stop offset="13%" stopColor="#e6f4ea" stopOpacity="0" />
            </linearGradient>
            <clipPath id="range-id-tsuid_31">
              <rect height="100%" width="0" x="0" y="0" />
            </clipPath>
            <defs>
              <linearGradient
            ...
            <clipPath id="mask-_f1bJZYLUHqWpxc8Prs2meA_32">
              <rect height="218" width="250" x="0" y="-5" />
            </clipPath>
          </defs>
          <path
