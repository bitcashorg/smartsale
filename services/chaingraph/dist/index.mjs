...
var GenqlError = class extends Error {
  ...
  constructor(errors, data) {
    let message = Array.isArray(errors)
      ? errors.map((x) => (x == null ? void 0 : x.message) || '').join('\n')
      : ''
    if (!message) {
    ...
    return async (body) => {
      ...
      if (Array.isArray(json)) {
        return json.map((json2) => {
          var _a2
          if (
            (_a2 = json2 == null ? void 0 : json2.errors) == null ? void 0 : _a2.length
          ) {
...
var createClient = ({ queryRoot, mutationRoot, subscriptionRoot, ...options }) => {
...
var types_default = {
  scalars: [
    0, 2, 3, 5, 13, 26, 34, 44, 53, 61, 76, 87, 99, 111, 120, 124, 126, 127, 134, 143,
    147, 154, 166, 170, 172, 182, 196, 200, 202, 209, 219, 227, 232, 240, 253, 261,
  ],
  types: {
    Boolean: {},
...
var isactions = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "isactions"')
...
var isblocks = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "isblocks"')
...
var ischains = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "ischains"')
...
var ismappings = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "ismappings"')
...
var istransactions_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "istransactions_aggregate_fields"')
...
var istransactions_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "istransactions_mutation_response"')
...
var istransactions_stddev_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "istransactions_stddev_pop_fields"')
...
var istransactions_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "istransactions_stddev_samp_fields"')
...
var iswhitelists_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename))
    throw new Error('__typename is missing in "iswhitelists_stddev_samp_fields"')
...
var generateMutationOp = (fields) =>
  generateGraphqlOperation('mutation', typeMap.Mutation, fields)
var generateSubscriptionOp = (fields) =>
  generateGraphqlOperation('subscription', typeMap.Subscription, fields)
