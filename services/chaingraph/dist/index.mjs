...
var isactions_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_aggregate"');
  return actions_aggregate_possibleTypes.includes(obj.__typename);
};
var actions_aggregate_fields_possibleTypes = ["actions_aggregate_fields"];
var isactions_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_aggregate_fields"');
...
var isactions_avg_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_avg_fields"');
...
var isactions_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_max_fields"');
...
var isactions_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_min_fields"');
  return actions_min_fields_possibleTypes.includes(obj.__typename);
};
var actions_mutation_response_possibleTypes = ["actions_mutation_response"];
var isactions_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_mutation_response"');
...
var isactions_stddev_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_stddev_fields"');
  return actions_stddev_fields_possibleTypes.includes(obj.__typename);
};
var actions_stddev_pop_fields_possibleTypes = ["actions_stddev_pop_fields"];
var isactions_stddev_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_stddev_pop_fields"');
  return actions_stddev_pop_fields_possibleTypes.includes(obj.__typename);
};
var actions_stddev_samp_fields_possibleTypes = ["actions_stddev_samp_fields"];
var isactions_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_stddev_samp_fields"');
...
var isactions_sum_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_sum_fields"');
  return actions_sum_fields_possibleTypes.includes(obj.__typename);
};
var actions_var_pop_fields_possibleTypes = ["actions_var_pop_fields"];
var isactions_var_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_var_pop_fields"');
  return actions_var_pop_fields_possibleTypes.includes(obj.__typename);
};
var actions_var_samp_fields_possibleTypes = ["actions_var_samp_fields"];
var isactions_var_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_var_samp_fields"');
  return actions_var_samp_fields_possibleTypes.includes(obj.__typename);
};
var actions_variance_fields_possibleTypes = ["actions_variance_fields"];
var isactions_variance_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isactions_variance_fields"');
  return actions_variance_fields_possibleTypes.includes(obj.__typename);
};
var api_users_possibleTypes = ["api_users"];
var isapi_users = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users"');
...
var isapi_users_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_aggregate"');
  return api_users_aggregate_possibleTypes.includes(obj.__typename);
};
var api_users_aggregate_fields_possibleTypes = ["api_users_aggregate_fields"];
var isapi_users_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_aggregate_fields"');
...
var isapi_users_avg_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_avg_fields"');
...
var isapi_users_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_max_fields"');
...
var isapi_users_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_min_fields"');
  return api_users_min_fields_possibleTypes.includes(obj.__typename);
};
var api_users_mutation_response_possibleTypes = ["api_users_mutation_response"];
var isapi_users_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_mutation_response"');
  return api_users_mutation_response_possibleTypes.includes(obj.__typename);
};
var api_users_stddev_fields_possibleTypes = ["api_users_stddev_fields"];
var isapi_users_stddev_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_stddev_fields"');
  return api_users_stddev_fields_possibleTypes.includes(obj.__typename);
};
var api_users_stddev_pop_fields_possibleTypes = ["api_users_stddev_pop_fields"];
var isapi_users_stddev_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_stddev_pop_fields"');
  return api_users_stddev_pop_fields_possibleTypes.includes(obj.__typename);
};
var api_users_stddev_samp_fields_possibleTypes = ["api_users_stddev_samp_fields"];
var isapi_users_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_stddev_samp_fields"');
...
var isapi_users_sum_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_sum_fields"');
  return api_users_sum_fields_possibleTypes.includes(obj.__typename);
};
var api_users_var_pop_fields_possibleTypes = ["api_users_var_pop_fields"];
var isapi_users_var_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_var_pop_fields"');
  return api_users_var_pop_fields_possibleTypes.includes(obj.__typename);
};
var api_users_var_samp_fields_possibleTypes = ["api_users_var_samp_fields"];
var isapi_users_var_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_var_samp_fields"');
  return api_users_var_samp_fields_possibleTypes.includes(obj.__typename);
};
var api_users_variance_fields_possibleTypes = ["api_users_variance_fields"];
var isapi_users_variance_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isapi_users_variance_fields"');
...
var isblocks_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_aggregate"');
  return blocks_aggregate_possibleTypes.includes(obj.__typename);
};
var blocks_aggregate_fields_possibleTypes = ["blocks_aggregate_fields"];
var isblocks_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_aggregate_fields"');
...
var isblocks_avg_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_avg_fields"');
...
var isblocks_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_max_fields"');
...
var isblocks_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_min_fields"');
  return blocks_min_fields_possibleTypes.includes(obj.__typename);
};
var blocks_mutation_response_possibleTypes = ["blocks_mutation_response"];
var isblocks_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_mutation_response"');
...
var isblocks_stddev_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_stddev_fields"');
  return blocks_stddev_fields_possibleTypes.includes(obj.__typename);
};
var blocks_stddev_pop_fields_possibleTypes = ["blocks_stddev_pop_fields"];
var isblocks_stddev_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_stddev_pop_fields"');
  return blocks_stddev_pop_fields_possibleTypes.includes(obj.__typename);
};
var blocks_stddev_samp_fields_possibleTypes = ["blocks_stddev_samp_fields"];
var isblocks_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_stddev_samp_fields"');
...
var isblocks_sum_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_sum_fields"');
...
var isblocks_var_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_var_pop_fields"');
  return blocks_var_pop_fields_possibleTypes.includes(obj.__typename);
};
var blocks_var_samp_fields_possibleTypes = ["blocks_var_samp_fields"];
var isblocks_var_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_var_samp_fields"');
  return blocks_var_samp_fields_possibleTypes.includes(obj.__typename);
};
var blocks_variance_fields_possibleTypes = ["blocks_variance_fields"];
var isblocks_variance_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isblocks_variance_fields"');
...
var ischains_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ischains_aggregate"');
  return chains_aggregate_possibleTypes.includes(obj.__typename);
};
var chains_aggregate_fields_possibleTypes = ["chains_aggregate_fields"];
var ischains_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ischains_aggregate_fields"');
...
var ischains_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ischains_max_fields"');
...
var ischains_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ischains_min_fields"');
  return chains_min_fields_possibleTypes.includes(obj.__typename);
};
var chains_mutation_response_possibleTypes = ["chains_mutation_response"];
var ischains_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ischains_mutation_response"');
  return chains_mutation_response_possibleTypes.includes(obj.__typename);
};
var manifests_possibleTypes = ["manifests"];
var ismanifests = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismanifests"');
...
var ismanifests_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismanifests_aggregate"');
  return manifests_aggregate_possibleTypes.includes(obj.__typename);
};
var manifests_aggregate_fields_possibleTypes = ["manifests_aggregate_fields"];
var ismanifests_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismanifests_aggregate_fields"');
...
var ismanifests_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismanifests_max_fields"');
...
var ismanifests_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismanifests_min_fields"');
  return manifests_min_fields_possibleTypes.includes(obj.__typename);
};
var manifests_mutation_response_possibleTypes = ["manifests_mutation_response"];
var ismanifests_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismanifests_mutation_response"');
...
var ismappings_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismappings_aggregate"');
  return mappings_aggregate_possibleTypes.includes(obj.__typename);
};
var mappings_aggregate_fields_possibleTypes = ["mappings_aggregate_fields"];
var ismappings_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismappings_aggregate_fields"');
...
var ismappings_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismappings_max_fields"');
...
var ismappings_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismappings_min_fields"');
  return mappings_min_fields_possibleTypes.includes(obj.__typename);
};
var mappings_mutation_response_possibleTypes = ["mappings_mutation_response"];
var ismappings_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismappings_mutation_response"');
...
var ismutation_root = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "ismutation_root"');
  return mutation_root_possibleTypes.includes(obj.__typename);
};
var query_root_possibleTypes = ["query_root"];
var isquery_root = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "isquery_root"');
  return query_root_possibleTypes.includes(obj.__typename);
};
var subscription_root_possibleTypes = ["subscription_root"];
var issubscription_root = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "issubscription_root"');
  return subscription_root_possibleTypes.includes(obj.__typename);
};
var table_rows_possibleTypes = ["table_rows"];
var istable_rows = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istable_rows"');
...
var istable_rows_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istable_rows_aggregate"');
  return table_rows_aggregate_possibleTypes.includes(obj.__typename);
};
var table_rows_aggregate_fields_possibleTypes = ["table_rows_aggregate_fields"];
var istable_rows_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istable_rows_aggregate_fields"');
...
var istable_rows_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istable_rows_max_fields"');
...
var istable_rows_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istable_rows_min_fields"');
  return table_rows_min_fields_possibleTypes.includes(obj.__typename);
};
var table_rows_mutation_response_possibleTypes = ["table_rows_mutation_response"];
var istable_rows_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istable_rows_mutation_response"');
...
var istransactions = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions"');
  return transactions_possibleTypes.includes(obj.__typename);
};
var transactions_aggregate_possibleTypes = ["transactions_aggregate"];
var istransactions_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_aggregate"');
  return transactions_aggregate_possibleTypes.includes(obj.__typename);
};
var transactions_aggregate_fields_possibleTypes = ["transactions_aggregate_fields"];
var istransactions_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_aggregate_fields"');
  return transactions_aggregate_fields_possibleTypes.includes(obj.__typename);
};
var transactions_avg_fields_possibleTypes = ["transactions_avg_fields"];
var istransactions_avg_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_avg_fields"');
  return transactions_avg_fields_possibleTypes.includes(obj.__typename);
};
var transactions_max_fields_possibleTypes = ["transactions_max_fields"];
var istransactions_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_max_fields"');
  return transactions_max_fields_possibleTypes.includes(obj.__typename);
};
var transactions_min_fields_possibleTypes = ["transactions_min_fields"];
var istransactions_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_min_fields"');
  return transactions_min_fields_possibleTypes.includes(obj.__typename);
};
var transactions_mutation_response_possibleTypes = ["transactions_mutation_response"];
var istransactions_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_mutation_response"');
  return transactions_mutation_response_possibleTypes.includes(obj.__typename);
};
var transactions_stddev_fields_possibleTypes = ["transactions_stddev_fields"];
var istransactions_stddev_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_stddev_fields"');
  return transactions_stddev_fields_possibleTypes.includes(obj.__typename);
};
var transactions_stddev_pop_fields_possibleTypes = ["transactions_stddev_pop_fields"];
var istransactions_stddev_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_stddev_pop_fields"');
  return transactions_stddev_pop_fields_possibleTypes.includes(obj.__typename);
};
var transactions_stddev_samp_fields_possibleTypes = ["transactions_stddev_samp_fields"];
var istransactions_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_stddev_samp_fields"');
  return transactions_stddev_samp_fields_possibleTypes.includes(obj.__typename);
};
var transactions_sum_fields_possibleTypes = ["transactions_sum_fields"];
var istransactions_sum_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_sum_fields"');
  return transactions_sum_fields_possibleTypes.includes(obj.__typename);
};
var transactions_var_pop_fields_possibleTypes = ["transactions_var_pop_fields"];
var istransactions_var_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_var_pop_fields"');
  return transactions_var_pop_fields_possibleTypes.includes(obj.__typename);
};
var transactions_var_samp_fields_possibleTypes = ["transactions_var_samp_fields"];
var istransactions_var_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_var_samp_fields"');
  return transactions_var_samp_fields_possibleTypes.includes(obj.__typename);
};
var transactions_variance_fields_possibleTypes = ["transactions_variance_fields"];
var istransactions_variance_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "istransactions_variance_fields"');
...
var iswhitelists = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists"');
...
var iswhitelists_aggregate = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_aggregate"');
  return whitelists_aggregate_possibleTypes.includes(obj.__typename);
};
var whitelists_aggregate_fields_possibleTypes = ["whitelists_aggregate_fields"];
var iswhitelists_aggregate_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_aggregate_fields"');
...
var iswhitelists_avg_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_avg_fields"');
...
var iswhitelists_max_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_max_fields"');
...
var iswhitelists_min_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_min_fields"');
  return whitelists_min_fields_possibleTypes.includes(obj.__typename);
};
var whitelists_mutation_response_possibleTypes = ["whitelists_mutation_response"];
var iswhitelists_mutation_response = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_mutation_response"');
  return whitelists_mutation_response_possibleTypes.includes(obj.__typename);
};
var whitelists_stddev_fields_possibleTypes = ["whitelists_stddev_fields"];
var iswhitelists_stddev_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_stddev_fields"');
  return whitelists_stddev_fields_possibleTypes.includes(obj.__typename);
};
var whitelists_stddev_pop_fields_possibleTypes = ["whitelists_stddev_pop_fields"];
var iswhitelists_stddev_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_stddev_pop_fields"');
  return whitelists_stddev_pop_fields_possibleTypes.includes(obj.__typename);
};
var whitelists_stddev_samp_fields_possibleTypes = ["whitelists_stddev_samp_fields"];
var iswhitelists_stddev_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_stddev_samp_fields"');
...
var iswhitelists_sum_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_sum_fields"');
  return whitelists_sum_fields_possibleTypes.includes(obj.__typename);
};
var whitelists_var_pop_fields_possibleTypes = ["whitelists_var_pop_fields"];
var iswhitelists_var_pop_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_var_pop_fields"');
  return whitelists_var_pop_fields_possibleTypes.includes(obj.__typename);
};
var whitelists_var_samp_fields_possibleTypes = ["whitelists_var_samp_fields"];
var iswhitelists_var_samp_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_var_samp_fields"');
  return whitelists_var_samp_fields_possibleTypes.includes(obj.__typename);
};
var whitelists_variance_fields_possibleTypes = ["whitelists_variance_fields"];
var iswhitelists_variance_fields = (obj) => {
  if (!(obj == null ? void 0 : obj.__typename)) throw new Error('__typename is missing in "iswhitelists_variance_fields"');
...
// src/client/index.ts
function createChaingraphClient({ config, options = {} } = {}) {
  const envConfig2 = loadEnvConfig(process.env.NEXT_PUBLIC_APP_ENV || "prod");
  const headers = {
...
import { loadEnvConfig as loadEnvConfig2 } from "@repo/config";
var chaingraph = createChaingraphClient();
var envConfig = loadEnvConfig2(process.env.NEXT_PUBLIC_APP_ENV || "dev");
