...
import type { PipeParameters, PipeReturnType } from '../hooks/use-pipeline'
...
export type OutgoingEventData = ProgressEventData | ReadyEventData | ResultEventData
...
self.addEventListener('message', async (event: MessageEvent<IncomingEventData>) => {
