...
export const CardItem = ({
  ...
  useEffect(() => {
    ...
    handleBadgeAnimations();
  }, [isMouseEntered]);

  const handleMainAnimations = () => {
  ...
  return (
    ...
    >
      ...
      {badge && (
        <div
          ref={badgeRef}
          className={cn(badgeVariants({ variant: 'secondary' }), 'transition duration-200 ease-in-out absolute top-4 right-4', badgeProps?.className)}
          {...rest}
          {...badgeProps}
        >
          {badge}
