...
export function ProjectDataCard({ project }: { project: Project }) {
  return (
    <div className="container relative z-10 flex size-full min-w-[95vw] flex-col items-center justify-between lg:flex-row px-0">
      <div className="flex size-full min-h-[560px] max-w-screen-md flex-col justify-between rounded-xl border border-card/30 bg-card/60 p-[0.75rem] backdrop-blur-lg md:px-11 md:py-8">
