  ...
  cards: [
    {
      ...
      paragraphs: [
        ...
        "We'll also cover key compliance details and the secure setup of your contributions using EVM-compatible wallets. This is an essential read for anyone looking to understand and engage with the future of technology and finance through Bitlauncher.",
      ],
      images: [
