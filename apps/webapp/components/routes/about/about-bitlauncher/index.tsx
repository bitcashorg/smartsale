      ...
      <section className="w-full py-12 narrow-container md:py-24 lg:py-32">
        <div className="px-0 md:px-6 grid items-center justify-between gap-4 lg:grid-cols-2">
          <div className="space-y-4">
            <h2 className="text-7xl">{content.title}</h2>
            <section className="leading-snug text-[#9395af]">
              Bitlauncher is a <b>pioneering launchpad</b> dedicated to
              ...
              innovation by providing open-source AI projects with equitable
              fundraising opportunities and decentralized organization through
              the use of blockchain technology.
              <br />
              <br />
              At Bitlauncher, we{' '}
              <b>combine the transformative powers of AI and cryptocurrency</b>{' '}
              to address the unique challenges faced by AI startups. By
              integrating tokenization and decentralized autonomous
              organizations (DAOs), we create a seamless synergy that enables
              these startups to overcome funding barriers, accelerate their
              growth, and harness global resources.
              <br />
              <br />
