...
export function ProjectHeader({ projectData }: { projectData: Project }) {
  ...
  return (
    <section className="w-full h-full flex flex-col gap-11 items-center justify-center">
      <div className="absolute inset-0 z-[1] h-full w-full bg-black/20 backdrop-blur-[2.5px] rounded-3xl overflow-hidden" />
      <Image
        alt="Project Image"
      ...
      >
        ...
        <motion.div
          ...
          className="min-h-[360px] w-full max-w-screen-sm flex flex-col justify-between gap-6 px-8 py-6 md:px-11 md:py-8 rounded-xl bg-card/60 backdrop-blur-lg"
        >
        ...
        <motion.div
          className="min-h-[360px] w-full max-w-screen-sm flex flex-col gap-6 px-8 py-6 md:px-11 md:py-8 rounded-xl bg-card/60 backdrop-blur-lg"
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
