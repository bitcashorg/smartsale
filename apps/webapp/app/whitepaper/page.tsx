...
const content: PageContentData = [
  ...
  },
  {
    type: 'ul',
    items: [
      "Decentralized AI Marketplaces: There's a growing trend towards decentralized platforms that allow for the buying and selling of AI services using cryptocurrencies.",
  ...
  },
  {
    type: 'ul',
    items: [
      'Regulatory Uncertainty: Both AI and cryptocurrency sectors face significant regulatory hurdles that can impact growth, innovation and operational freedom.',
  ...
  },
  {
    type: 'ul',
    items: [
      'Innovative Funding Models: Tokenization opens up new avenues for funding AI projects beyond traditional venture capital, particularly those that are open-source and community-driven.',
  ...
  },
  {
    type: 'ul',
    items: [
      'Focusing exclusively on open-source AI projects, addressing a gap in the market for these ventures to secure funding and organize efficiently.',
  ...
  },
  {
    type: 'ul',
    items: [
      'Fostering Innovation: To support the development of over 100 open-source AI projects within the next five years, transforming ideas into viable solutions that address real-world problems.',
  ...
  },
  {
    type: 'ul',
    items: [
      'Strategic Partnerships: Collaborating with leading academic institutions, technology companies, and open-source communities to provide projects with the resources, expertise, and exposure they need to succeed.',
  ...
  {
    type: 'p',
    text: 'At the heart of Bitlauncher is a commitment to leveraging cutting-edge technology and innovative practices to empower AI startups. Our platform provides a comprehensive suite of tools and resources designed to support AI projects in every phase of their journey, from inception to scale. By integrating advanced blockchain technology and DAO (Decentralized Autonomous Organization) principles, we ensure transparency, efficiency, and trustworthiness in all operational facets.'
  },
  {
    type: 'h2',
  ...
  },
  {
    type: 'ul',
    items: [
      'Cryptocurrency Payment Wallet and P2P Crypto Onramp: Featuring forex capabilities, our wallet simplifies transactions, making the transfer of funds as straightforward as traditional banking.',
  ...
  {
    type: 'p',
    text: 'In addition, the Bitcash team behind Bitlauncher has developed dBoard, a comprehensive DAO decision-making and community management tool. This platform enables stakeholders to engage in discussions, strategy formulation, and voting on crucial decisions, thereby fostering a collaborative and productive environment for organizational growth'
  },
  {
    type: 'h2',
    text: 'A Vision for a Non-Profit, Fair L1 Chain.'
  },
  {
    type: 'p',
  ...
  {
    type: 'p',
    text: "Owning Bitcash tokens places you at the heart of our DAO's consensus-driven governance processes, enabling you to vote on pivotal proposals and influence the strategic trajectory of the platform. This model nurtures a cooperative environment where each member actively shapes the project's outcomes, transcending the passive investor role found in conventional investment scenarios."
  },
  {
    type: 'h2',
  ...
  },
  {
    type: 'ul',
    items: [
      'Fundraising Token Launch: Raise up to $250k for Bitcash/Bitlauncher as the first project on the launchpad',
  ...
  },
  {
    type: 'ul',
    items: [
      'Marketing and Community Building: Aggressive marketing campaigns, hackathons and community building efforts to attract a broader audience and increase platform adoption.',
      ...
      'Initiate development of multi-chain EVM wallet leveraging account abstraction tied to the identity chain to interoperate with the wider crypto ecosystem.'
    ]
  },
  {
    type: 'h2',
  ...
  {
    type: 'p',
    text: 'Marketing & Community (30%) $120k:'
  },
  {
    type: 'ul',
    items: ['Content, Social Media, Hackathons, Events, Global Ambassadors']
  },
  {
    type: 'p',
    text: 'Business & Operations (30%) $120k:'
  },
  {
    type: 'ul',
    items: ['Startup Deal Making, DAO process improvements & AI integration']
  },
  {
    type: 'p',
    text: 'Development: (40%) $160k:'
  },
  {
    type: 'ul',
    items: [
      'Improvements/Maintenance: Launchpad, Wallet/Onramp/Forex, dBoard, Security',
      'Complete: Simple Wallet, Referral System, Secondary Market Exchange',
      'Initiate/Build: Layer 1 Chain, Key Recovery, Multi-chain EVM'
    ]
  },
  { type: 'h1', text: 'Launch Team' },
  {
    type: 'h2',
    text: 'Jun Dam, MBA, CFA (Founder 2015 / Product / Financial Architect):'
  },
  {
    type: 'p',
  ...
  {
    type: 'p',
    text: 'Jimoh is a skilled application developer with a strong focus on creating intuitive user interfaces and implementing complex logic while maintaining clean coding practices. He excels in collaborative environments, actively participating in feature planning and solution building to ensure high-quality deliverables that meet both user needs and business goals. His expertise lies in seamlessly integrating technical proficiency with team contributions to achieve optimal results in software development projects.'
  },
  {
    type: 'h2',
    text: 'Luis Carrion:'
  ...
  },
  {
    type: 'ul',
    items: [
      'Proactive Legal Monitoring: We continuously monitor global regulatory developments in the crypto and AI spaces, ensuring that our platform remains compliant with current laws and regulations. This includes engaging with legal experts and advisors who specialize in these sectors.',
  ...
  },
  {
    type: 'ul',
    items: [
      'End-to-End Encryption: Data transmitted to and from our platform is protected using robust end-to-end encryption, ensuring that user data remains confidential and secure.',
  ...
  {
    type: 'p',
    text: 'By intertwining rigorous regulatory compliance with comprehensive security measures, our platform not only protects our users and their assets but also establishes a foundation of trust and reliability essential for fostering innovation and growth in the crypto and AI spaces.'
  },
  ...
  },
  {
    type: 'ul',
    items: [
      'Register for a Bitcash wallet account at our official site',
      ...
      'Geolocation Verification: Ensure your device’s privacy settings permit geolocation sharing to prevent sybil attacks',
  ...
  },
  {
    type: 'ul',
    items: [
      'Connect an EVM-Compatible Wallet: Use wallets like Metamask to deposit USDT or USDC into the Bitcash deposit contract available on various EVM chains, including Ethereum, Cosmos, Arbitrum, Optimism, Base, and Avalanche.',
  ...
  },
  {
    type: 'ul',
    items: [
      'Fair Price Discovery: Our platform employs batch auctions for equitable price discovery, benefiting from the mechanism’s efficiency in matching buyers and sellers at a uniform clearing price.',
      ...
      "Token Distribution: Tokens are allocated within two weeks post-sale. It's important to note that early-stage tokens might not be immediately listed on external exchanges but could gain liquidity through monthly auctions or a potential internal Bitcash secondary exchange in the future"
    ]
  },
  {
    type: 'h2',
  ...
  },
  {
    type: 'ul',
    items: [
      'Wallets and Exchanges: Information on supported wallets and future exchange listings will be updated periodically. Stay informed through our official channels.',
      'Compliance: Adhering to KYC and AML regulations not only ensures your security but also underpins the integrity of our account recovery system.'
    ]
  },
  {
    type: 'p',
  ...
  {
    type: 'h2',
    text: 'FAQs: Navigating the Landscape of Our Launchpad'
  },
  {
    type: 'p',
    text: 'This section addresses the most frequently asked questions about our launchpad, its associated token sale, and the overarching vision of the project, providing clarity and insight into our mission to revolutionize the intersection of cryptocurrency and artificial intelligence.'
  },
  {
    type: 'h2',
    text: '1. What is the primary purpose of the launchpad? '
  },
  {
    type: 'p',
    text: 'The launchpad is designed to empower AI startups by providing them with a platform for tokenization and access to a global pool of investors, facilitating easier funding and organization through the innovative use of DAO technology and cryptocurrency.'
  },
  {
    type: 'h2',
    text: '2. How does the token sale work?'
  },
  {
    type: 'p',
    text: 'Our token sale operates as a batch auction, ensuring a fair price discovery mechanism that benefits both investors and startups. Tokens are issued based on current market valuations, allowing for equitable investment opportunities while fostering growth and adding value to the organization.'
  },
  {
    type: 'h2',
    text: '3. Who can participate in the token sale?'
  },
  {
    type: 'p',
    text: 'The token sale is open to a global audience, with specific restrictions excluding participants from the US and US-sanctioned countries to comply with regulatory standards and ensure the broadest possible participation while maintaining legal integrity.'
  },
  {
    type: 'h2',
    text: '4. What sets this project apart from other ICOs or token sales?'
  },
  {
    type: 'p',
    text: 'Our project uniquely focuses on the AI sector, employing a mint-and-burn model for tokenomics that mirrors the shareholder model, emphasizing sustainable growth, transparency, and community engagement in the tech startup ecosystem.'
  },
  {
    type: 'h2',
    text: '5. How will the funds raised from the token sale be used?'
  },
  {
    type: 'p',
    text: "Funds from the token sale are primarily allocated to further development and marketing of the launchpad and wallet, as well as the creation of the non-profit, no-premine L1 chain based on Antelope technology, aiming for the fairest token distribution and contributing to the ecosystem's growth and sustainability."
  },
  {
    type: 'h2',
    text: '6. How does the launchpad ensure regulatory compliance and security?'
  },
  {
    type: 'p',
    text: 'We adopt a proactive approach to regulatory compliance, including user restrictions, KYC and AML policies, and adherence to data protection laws, alongside implementing robust security measures such as end-to-end encryption and regular security audits.'
  },
  {
    type: 'h2',
    text: '7. What support does the launchpad offer to startups?'
  },
  {
    type: 'p',
    text: 'Beyond funding, the launchpad offers startups access to a network of resources, including guidance on business management, marketing, and development, along with tools for efficient payment processing and organizational management through DAO technology.'
  },
  {
    type: 'h2',
    text: '8. How can startups and investors benefit from participating in the launchpad?'
  },
  {
    type: 'p',
    text: 'Startups gain access to capital, resources, and a global community, enhancing their growth potential and market reach. Investors benefit from early access to innovative AI projects with high growth potential, contributing to a diversified and forward-looking investment portfolio.'
  },
  {
    type: 'h2',
    text: '9. How does the project contribute to the broader AI and crypto communities?'
  },
  {
    type: 'p',
    text: 'By facilitating the growth and development of AI startups within the crypto framework, our project contributes to the advancement of technology, encourages ethical and sustainable business practices, and fosters a community of innovation at the intersection of these two dynamic fields.'
  },
  {
    type: 'h2',
    text: '10. Where can I find more information or get involved? '
  },
  {
    type: 'p',
    text: 'For more detailed information, updates, and to join our community, visit our official website, join our social media channels, and subscribe to our newsletter. We welcome everyone interested in contributing to or participating in the future of AI and cryptocurrency through our launchpad.'
  },
  {
    type: 'ul',
    items: [
      'Twitter: @bitcashorg / @bitlauncherai',
      'Blog: https://blog.bitcash.org/',
      'Discord: https://discord.gg/eJCfx4JAqY',
      'Youtube: https://www.youtube.com/@bitcashorg',
  ...
  {
    type: 'p',
    text: 'Blockchain: A decentralized, distributed ledger technology that records transactions across multiple computers in a way that ensures security, transparency, and immutability. Cryptocurrency: Digital or virtual currency that uses cryptography for security and operates independently of a central bank, leveraging blockchain technology for decentralized financial transactions.'
  },
  {
    type: 'p',
    text: 'Decentralized Autonomous Organization (DAO): A type of organization represented by rules encoded as a computer program that is transparent, controlled by the organization members, and not influenced by a central government.'
  },
  {
    type: 'p',
    text: 'Tokenization: The process of converting rights to an asset into a digital token on a blockchain, facilitating easier and more flexible transactions.'
  },
  {
    type: 'p',
    text: "Mint-and-Burn Model: A tokenomics strategy where tokens are 'minted' or created to increase supply and 'burned' or destroyed to reduce supply, often used to manage a token's value and supply."
  },
  {
    type: 'p',
    text: 'Batch/Dutch Auction: A market structure in which the price of an offering is established after taking in all bids to determine the highest price at which the total offering can be sold.'
  },
  {
    type: 'p',
    text: 'Gnosis Auction: A platform that allows for fair price discovery and decentralized auctions, particularly used within the Ethereum ecosystem.'
  },
  {
    type: 'p',
    text: 'EOS EVM: Refers to the EOSIO Ethereum Virtual Machine, which enables Ethereum smart contracts to run on the EOS blockchain, enhancing performance and scalability.'
  },
  {
    type: 'p',
    text: 'Smart Contracts: Self-executing contracts with the terms of the agreement between buyer and seller being directly written into lines of code, allowing for transactions and agreements to be carried out without the need for a central authority, legal system, or external enforcement mechanism.'
  },
  {
    type: 'p',
    text: 'KYC (Know Your Customer): A process of verifying the identity of clients by businesses, particularly in the financial sector, to prevent identity theft, financial fraud, money laundering, and terrorist financing.'
  },
  {
    type: 'p',
    text: 'AML (Anti-Money Laundering): A set of procedures, laws, and regulations designed to stop the practice of generating income through illegal actions and ensuring investments are not used for funding illegal activities.'
  },
  {
    type: 'p',
    text: 'GDPR (General Data Protection Regulation): A regulation in EU law on data protection and privacy in the European Union and the European Economic Area, focusing on giving control to individuals over their personal data.'
  },
  {
    type: 'p',
    text: "End-to-End Encryption: A method of secure communication that prevents third-parties from accessing data while it's transferred from one end system or device to another."
  },
  {
    type: 'p',
    text: 'Penetration Testing: A simulated cyber attack against your computer system to check for exploitable vulnerabilities.'
  },
  {
    type: 'p',
    text: 'Hot-stuff Consensus Mechanism: A leader-based consensus mechanism known for its high performance and strong security properties, particularly in blockchain environments.'
  },
  {
    type: 'p',
    text: 'Seed Funding: An initial investment to start a business in exchange for equity or an interest in the company.'
  },
  {
    type: 'p',
    text: 'WebAuthn: A web standard published by the World Wide Web Consortium (W3C) for secure and passwordless authentication on the Web, part of the FIDO2 specification.'
  },
  {
    type: 'p',
  ...
  {
    type: 'ul',
    items: ['Email: developers@bitcash.org']
  },
  {
    type: 'h2',
    text: 'Social Media:'
  ...
  {
    type: 'p',
    text: 'For real-time updates and announcements, follow us on our social media platforms and join our community discussions. We are committed to transparency and open communication and look forward to your participation and feedback.'
  },
  {
    type: 'p',
    text: 'If you encounter any issues or require assistance during the participation process or afterwards, our dedicated support team is available to help you resolve your queries promptly and efficiently.'
  }
]
