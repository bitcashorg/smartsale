...
export const metadata: Metadata = {
  title: 'Security Tips | Morlauncher',
  description:
...
const securityTips = [
  {
    ...
    content:
      'Phishing is a common technique used by attackers to gain access to your personal information. Always verify the URL of the Morlauncher and ensure it is the legitimate site before connecting your MetaMask wallet. Be cautious of emails or websites impersonating Morlauncher.'
  },
  {
  ...
  },
  {
    ...
    content:
      'Be wary of individuals on platforms like Discord and social media who claim to be representatives of Morlauncher. Official staff will never ask for your private keys or wallet credentials.'
  },
  {
  ...
  },
  {
    ...
    content:
      'Follow only the official Morlauncher channels for updates and information. Do not trust unverified sources.'
  },
  {
    title: 'Report Suspicious Activities',
    content:
      'If you encounter any suspicious activity or believe you are a victim of a scam, contact the official Morlauncher support immediately.'
  }
] as const

// Define the content using mapped security tips
const content: PageContentData = [
  { type: 'h1', text: 'Security Recommendations for Morlauncher Participants' },
  {
    type: 'p',
    text: 'Participating in auctions on Morlauncher, a fork of Gnosis, requires vigilance and awareness of various security threats. Here are some crucial tips to help keep your investments safe:'
  },
