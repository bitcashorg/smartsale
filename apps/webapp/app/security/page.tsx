...
export default function SecurityTips() {
  return (
    <div>
      ...
      <h2>1. Beware of Phishing Attacks</h2>
      <p>
      ...
      <h2>3. Impersonation on Discord and Social Media</h2>
      <p>
      ...
      <h2>4. Secure Your Digital Environment</h2>
      <p>
      ...
      <p>Stay vigilant and always prioritize your digital security!</p>
    </div>
  )
}
