      ...
      >
        ...
        >
          <BackgroundMovingGradient>
            ...
            <div className="absolute z-50 inset-0 flex size-full min-h-screen flex-col items-center justify-start overflow-x-hidden bg-dot-black/[0.1] dark:bg-dot-white/[0.1]">
              <Toaster />
              <Header />
              <main className="flex flex-1 flex-col py-5">
                <div className="container">{children}</div>
              </main>
              <footer className="flex flex-1 flex-col pt-32 pb-72 px-4">
                <Participate />
                <Newsletter />
              </footer>
              <ErrorModal />
