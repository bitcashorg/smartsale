export default {
  ...
  questions: [
    {
      question: 'Navegando pela paisagem do nosso Launchpad',
      answer:
    ...
    {
      question: 'Qual é o objetivo principal da barra de lançamento?',
      answer:
    ...
    {
      question: 'Como funciona a venda de tokens?',
      answer:
    ...
    {
      question: 'Quem pode participar da venda de tokens?',
      answer:
    ...
    {
      question: 'Qual suporte o launchpad oferece às startups?',
      answer:
