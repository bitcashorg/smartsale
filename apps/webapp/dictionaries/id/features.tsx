...
export const featuresContent: FeatureContent[] = [
    {
      title: 'Fitur',
      description: 'Temukan kemampuan utama yang menjadikan Bitlauncher platform utama untuk keuangan terdesentralisasi.',
    },
    {
    ...
    {
      title: 'Alat Organisasi Otonomi Terdesentralisasi (DAO).',
      description:
