                ...
                <CardContent className="max-w-[1210px] w-full mx-auto flex justify-center items-center gap-x-28 md:px-5 md:py-12 ">
                    ...
                    <Card className='mt-6 md:mt-0 w-full md:bg-transparent border-none md:overflow-visible'>
                        <CardHeader className="px-3 md:p-0 md:mb-6">
                            <h2 className="text-2xl md:text-3xl font-bold text-left text-white/30">Earn <span className="text-white/100">20%</span> of founds raised</h2>
                        </CardHeader>
                        <CardContent className="px-3 md:p-0">
                            <div className="w-full grid grid-cols-2 grid-rows-auto gap-3 md:gap-16">
                                <Card>
                                    <CardContent className="w-full bg-accent-600/70 rounded-2xl p-4 flex justify-start items-center gap-x-3 col-start-1 col-end-2 row-start-1 row-end-2 max-h-[81px] md:max-h-[102px] overflow-x-auto overflow-y-hidden lg:px-10 lg:py-6 lg:max-h-24">
                                        <picture>
                                ...
                                <Card>
                                    <CardContent className="w-full bg-accent-600/70 rounded-2xl p-4 flex justify-start items-center gap-x-3 col-start-2 col-end-3 row-start-1 row-end-2 max-h-[81px] md:max-h-[102px] overflow-x-auto overflow-y-hidden lg:px-10 lg:py-6 lg:max-h-24">
                                        <picture>
                                ...
                                <div className="w-full flex justify-between items-center gap-x-5 col-start-1 col-end-3 row-start-2 row-end-3 max-h-[81px] md:max-h-[64px]">
                                    <Card className="w-full h-full md:h-16 lg:min-w-[360px] xl:min-w-[470px]">
                                        <CardContent className="bg-accent-600/70 rounded-2xl px-6 py-4 flex justify-between items-center gap-x-4 w-full md:py-0 md:max-w-[360px] xl:min-w-[470px] overflow-auto lg:overflow-hidden h-full">
                                            <p className="text-base opacity-70 lg:min-w-36 lg:max-w-36 lg:overflow-hidden lg:text-ellipsis xl:min-w-52 xl:max-w-52 text-white md:text-2xl md:font-medium">{userShortLink}</p>
