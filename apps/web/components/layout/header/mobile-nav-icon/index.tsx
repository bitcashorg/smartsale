...
export function MobileNavIcon({ isOpen, onClick }: { isOpen?: boolean, onClick?: (param?: any) => void }) {
    return (
        <div onClick={onClick} className="relative w-7 h-5 mx-auto rotate-0 transition duration-500 ease-in-out pointer">
