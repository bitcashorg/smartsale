...
export default function ReferralDesktopList({
  referralList,
      ...
      {referralList.map(
        (
          ...
          <AccordionItem
            key={id}
            className={cn(
              index === 0 ? '[&_svg]:self-start [&_svg]:mt-5' : '',
              'data-[state=open]:bg-accent-600 rounded-lg border-none px-[72px]',
            )}
            value={id.toString()}
          >
            <AccordionTrigger className="hover:no-underline">
              <Table>
                <TableHeader
                  className={cn(index !== 0 ? 'hidden' : '', 'w-full')}
                >
                  <TableRow>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="text-left whitespace-nowrap w-[25%]">
                      {date}
                    </TableCell>
                    <TableCell className="text-left whitespace-nowrap w-[25%]">
                      {referralUser}
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="flex justify-start items-center gap-x-3 whitespace-nowrap w-[25%]">
                      {' '}
