...
import { Avatar, AvatarFallback, AvatarImage, Button, buttonVariants, Card, IconDownRightArrow } from '@repo/ui'
        ...
        <div className="text-left">
          <h1 className="heroHeading">
            <Balancer>
              EARLY ACCESS
              <br />
              TO THE NEXT <span className="text-accent-400">GLOBAL AI</span>{' '}
              <br />
