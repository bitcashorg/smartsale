...
import { TablesInsert } from '../src/supa.types';

const supabase = createClient('https://mitkjznioyrucenuzsdb.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1pdGtqem5pb3lydWNlbnV6c2RiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTMxMzA3MzgsImV4cCI6MjAyODcwNjczOH0.uVdiJfaonQfWvL--71QFAdiXGMiN1SRYlYGLNiSuNC0')
...
try {
  ...
  const deleteRes = await supabase
    .from('orders')
    .delete()
    .neq('auction_id', 0) // This condition ensures all rows are deleted
